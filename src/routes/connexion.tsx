...
export default function Connexion() {
  ...
  return (
    <>
      ...
      <FormArea name="Mot de passe" title="" titletext={false} validitertext={true} validiter={true} textvalider="mot de passe correct" textinvalider="mot de passe incorrect" difficulty={false} />
